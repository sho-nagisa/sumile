...
namespace sumile.Migrations
{
    ...
    [Migration("20260701150710_AddShiftImportHistory")]
    partial class AddShiftImportHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sumile.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("ShiftImportApiKey")
                        .HasColumnType("text");

                    b.Property<string>("ShiftPdfSearchName")
                        .HasColumnType("text");

                    b.Property<int?>("ShiftPdfStaffRowNumber")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("sumile.Models.ShiftDay", b =>
                {
                    ...
                    b.HasIndex("RecruitmentPeriodId", "Date")
                        .IsUnique();
            ...
            modelBuilder.Entity("sumile.Models.ShiftImportHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UserId", "RangeStartDate", "RangeEndDate")
                        .IsUnique();

                    b.ToTable("ShiftImportHistories");
                });
            ...
            modelBuilder.Entity("sumile.Models.ShiftSubmission", b =>
                {
                    ...
                    b.HasIndex("UserId", "ShiftDayId", "ShiftType")
                        .IsUnique();

                    b.ToTable("ShiftSubmissions");
                });

            modelBuilder.Entity("sumile.Models.SubmitBackup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("RecruitmentPeriodId", "ShiftDayId");
